<?php include_once 'includes/templates/header.php'; ?>
    ...
    <section class="seccion contenedor">
        ...
        <form action="pagar.php" id="Registro" method="POST" class="registro">
            <div id="datos_usuarios" class="clearfix caja registro">
                <div class="campo">
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" id="pase_dia" min="0" size="3" placeholder="0" name="boletos[un_dia][cantidad]">
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" id="pase_completo" min="0" size="3" placeholder="0" name="boletos[completo][cantidad]">
                    ...
                    <li>
                        <div class="tabla-precio">
                            ...
                            <div class="orden">
                                ...
                                <input type="number" id="pase_dosdias" min="0" size="3" placeholder="0" name="boletos[dos_dias][cantidad]" >
                                <input type="hidden" name="boletos[dos_dias][precio]" value="45">
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="resumen" id="resumen">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            <label for="camisa_evento">Camisa del evento $10 <small>(10% de descuento)</small></label>
                        ...
                        <!-- orden  -->
                        <div class="orden">
                            <label for="etiquetas">Paquete de Etiquetas $2 <small>(HTML5, CSS, JavaScript, Chrome)</small></label>
